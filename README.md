...
6. To run the [isoCycle_example.ipynb](https://github.com/esiabri/isoCycle/tree/main/example/isoCycle_example.ipynb) refer to [example](https://github.com/esiabri/isoCycle/tree/main/isoCycle/example)
</p>
